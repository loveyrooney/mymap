...
public interface GeomService {
    List<MarkerDTO> findGeoms(List<MarkerClusterDTO> clusters, Long auth, String fromName);
    ...
    java.util.Map<String, String> findBusStationNames(String stId, String routeId, Integer staOrder);
}
